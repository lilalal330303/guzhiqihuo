...
def init(context):
    ...
    _register_schedule()
    log.info("WUFU_THS_FAST_V12B_COMPACT_BESTTIME init_cash={} auto_weak={} fallback_external={} weak_calendar_version={} external_source={} start={} end={} ranges={} dynamic_pool={} full_market_threshold={}".format(
        INIT_CASH,
        ...
        len(EXTERNAL_WEAK_RANGES), USE_DYNAMIC_POOL, USE_FULL_MARKET_THRESHOLD
    ))
    log.info("WUFU_THS_FAST_V12B_COMPACT_BESTTIME diagnostics={} execution_buffer={} round_lot={} score_detail_top_n={} weak_min_valid={} weak_indexes={} a300_probe_indexes={} compact_logs=True".format(
