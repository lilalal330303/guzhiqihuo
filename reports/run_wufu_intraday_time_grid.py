...
PREFIX = ROOT / "reports" / "wufu_intraday_time_grid"


STOP_WINDOWS = {
    "full": ((941, 1028), (1041, 1129), (1301, 1456)),
    "afternoon": ((1301, 1456),),
    "post_entry": ((1312, 1456),),
}
TREND_CHECK_SETS = {
    "1340_1410": (1340, 1410),
    "1320_1340_1410": (1320, 1340, 1410),
...
FORCE_BUY_MINUTES = [1440, 1450, 1455]
...
- 检测/初始买入时间：不启用、13:11、13:20
- 止损时间：全日窗口、仅下午、买入后下午
- 趋势判断时间：13:40/14:10，13:20/13:40/14:10，13:40/14:10/14:30
- 强制买入时间：14:40、14:50、14:55
...
本轮样本只覆盖近期真实分钟线，适合判断日内时间参数方向，不适合直接作为长期最终参数。若 Top10 集中在“无初始买入”，说明趋势确认比立即进场更优；若集中在 13:11 或 13:20，则说明早进场在这段样本中有优势。

止损时间若偏向“仅下午”或“买入后下午”，通常意味着上午止损容易卖飞；若“全日窗口”占优，则说明盘中防守对这段样本有效。

下一步建议用 V12-A 双平台脚本重跑，并把本轮 Top3 时间组合分别迁移到同花顺和聚宽脚本做平台日志验证。
"""
