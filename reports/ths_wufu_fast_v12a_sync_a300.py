...
WEAK_CALENDAR_VERSION = "joinquant_v4_ranges_20200102_20260706_v12a_sync_base"
...
def init(context):
    ...
    _register_schedule()
    log.info("WUFU_THS_FAST_V12A_SYNC_A300 init_cash={} auto_weak={} fallback_external={} weak_calendar_version={} external_source={} start={} end={} ranges={} dynamic_pool={} full_market_threshold={}".format(
        INIT_CASH,
    ...
    log.info("WUFU_THS_FAST_V12A_SYNC_A300 diagnostics={} execution_buffer={} round_lot={} score_detail_top_n={} weak_min_valid={} weak_indexes={} a300_probe_indexes={}".format(
    ...
    log.info("WUFU_INTRADAY_CONFIG enabled={} trend_lookback_minutes={} trend_slope_threshold={} trend_checks={} force_buy={} stop_loss_enabled={} stop_loss_threshold={}".format(
        INTRADAY_TIMING_ENABLED, TREND_LOOKBACK_MINUTES, TREND_SLOPE_THRESHOLD,
        ",".join([str(x) for x in TREND_CHECK_HHMMS]), FORCE_BUY_HHMM,
        FIXED_STOP_LOSS_ENABLED, FIXED_STOP_LOSS_THRESHOLD
    ))
...
def minute_level_stop_loss(context, data=None):
    ...
    now = get_datetime()
    hhmm = int(now.strftime("%H%M"))
    if not ((940 < hhmm < 1029) or (1040 < hhmm < 1130) or (1300 < hhmm < 1457)):
        return
...
def check_weak_state(context):
    ...
    if external is not None:
        ...
        log.info("WUFU_WEAK_AUTO_COMPARE date={} calendar_weak={} auto_name={} auto_weak={} valid={} below={} above={} detail={}".format(
            today, external, a300["name"], a300["weak"], a300["valid"], a300["below"], a300["above"], a300["detail"]
        ))
        return external
    below = 0
    above = 0
