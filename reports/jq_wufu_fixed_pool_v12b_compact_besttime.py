...
def initialize(context):
    ...
    log.info("WUFU_JQ_FIXED_POOL_V12B_COMPACT_BESTTIME expected_init_cash={} schedule morning=09:40 signal=13:10 execute=13:11 trend=13:40,14:10,14:30 force_buy={} reset=15:10 diagnostics={} execution_buffer={} round_lot={} weak_calendar_version={} weak_indexes=000300.XSHG,399101.XSHE,399006.XSHE,000510.XSHG".format(
