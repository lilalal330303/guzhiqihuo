...
def init(context):
    ...
    _register_schedule()
    log.info("WUFU_THS_FAST_V9 auto_weak={} fallback_external={} weak_calendar_version={} external_source={} start={} end={} ranges={} dynamic_pool={} full_market_threshold={}".format(
    ...
    log.info("WUFU_THS_FAST_V9 diagnostics={} execution_buffer={} round_lot={} score_detail_top_n={} weak_min_valid={} weak_indexes={}".format(
