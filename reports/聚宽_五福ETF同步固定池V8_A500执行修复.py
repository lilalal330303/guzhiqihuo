...
def initialize(context):
    ...
    log.info("WUFU_JQ_FIXED_POOL_V8 schedule morning=09:40 signal=13:10 execute=13:11 reset=15:10 diagnostics={} execution_buffer={} round_lot={} weak_indexes=000300.XSHG,399101.XSHE,399006.XSHE,000510.XSHG".format(
