# -*- coding:utf-8 -*-
"""
JoinQuant version: Wufu ETF rotation V11 sync/verification script.
...
def initialize(context):
    ...
    log.info("WUFU_JQ_FIXED_POOL_V11_INTRADAY_BEST schedule morning=09:40 signal=13:10 execute=13:11 trend=13:40,14:10 force_buy={} reset=15:10 diagnostics={} execution_buffer={} round_lot={} weak_calendar_version={} weak_indexes=000300.XSHG,399101.XSHE,399006.XSHE,000510.XSHG".format(
