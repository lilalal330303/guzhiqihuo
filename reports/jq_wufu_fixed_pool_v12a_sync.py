...
def initialize(context):
    ...
    log.info("WUFU_JQ_FIXED_POOL_V12A_SYNC expected_init_cash={} schedule morning=09:40 signal=13:10 execute=13:11 trend=13:40,14:10 force_buy={} reset=15:10 diagnostics={} execution_buffer={} round_lot={} weak_calendar_version={} weak_indexes=000300.XSHG,399101.XSHE,399006.XSHE,000510.XSHG".format(
    ...
    if g.target_etfs_list:
        ...
        if INTRADAY_TIMING_ENABLED:
            ...
            if g.pending_buy_etfs:
                log.info("WUFU_PENDING_BUY date={} pending={} next_checks=13:40,14:10 force_buy={}".format(
